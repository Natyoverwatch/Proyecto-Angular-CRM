...
export class SolicitarOportunidadComponent {
  oportunidad: OportunidadModel = new OportunidadModel(
    '',
    '',
    'Sin gestor',
    '',
  ...
  checkNombreServicio() {
    if (!this.oportunidad.nameOportunity) {
      ...
      document
        ...
        ?.classList.add('proyecto-invalid-field');
    } else {
      // Si el campo está completo, eliminar la clase de estilo
      document
        .getElementById('nombre')
        ?.classList.remove('proyecto-invalid-field');
    }
  }
  ...
  checkDescripcion() {
    if (!this.oportunidad.descriptionOportunity) {
      // Agregar una clase de estilo para resaltar el campo en rojo
      document
        .getElementById('descriptionOportunity')
        ?.classList.add('proyecto-invalid-field');
    } else {
      // Si el campo está completo, eliminar la clase de estilo
      document
