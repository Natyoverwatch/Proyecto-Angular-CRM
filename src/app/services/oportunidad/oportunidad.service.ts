...
export class OportunidadService {
  ...
  getSinGestor() {
    return this.httpClient.get(
      `${base_url}/oportunidad/sin-gestor`,
      this.headers
    );
  }
  ...
  asignarGestor(idOpor: string, usuarioGestor: string) {
    return this.httpClient.put(
      `${base_url}/oportunidad/asignar/${idOpor}`,
      { userGestor: usuarioGestor },
      this.headers
    );
  }
  ...
  editarOportunidad(cambios: any, oportunidadId: string) {
    return this.httpClient.put(
      `${base_url}/oportunidad/${oportunidadId}`,
      cambios,
      this.headers
    );
  }
  ...
  getInteraccionOpor(oportunidadId: string) {
    return this.httpClient.get(
      `${base_url}/interaccion/oportunidad/${oportunidadId}`,
      this.headers
    );
  }
  ...
  editarInteraccion(interaccion: InteraccionModel, interaccionid: string) {
    return this.httpClient.put(
      `${base_url}/interaccion/${interaccionid}`,
      interaccion,
      this.headers
    );
  }
